...
import it.unibo.adozione_animali.view.pulsanti.centri.Delete;

public class DeleteCentroController {
    private final Model model;
    private final Delete view;

    public DeleteCentroController(Model model, Delete view) {
        this.model = model;
        this.view = view;
        inizializza();
    }
    ...
    public void salvaDelete() {
        ...
        view.showEsito(model.getCentroDAO().deleteCentro(provincia, citta, Integer.parseInt(numero)));
    }
}
