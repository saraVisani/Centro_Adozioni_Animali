...
import it.unibo.adozione_animali.view.pulsanti.centri.AddSpecie;

public class InserimentoSpecieCentroController {

    private final Model model;
    private final AddSpecie view;

    public InserimentoSpecieCentroController(Model model, AddSpecie view) {
        this.model = model;
        this.view = view;
        inizializza();
    }
    ...
    public void salvaInserimento() {
        ...
        view.showEsito(model.getCentroDAO().updateCentroAggiungiSpecie(provincia, citta, Integer.parseInt(numero), codiciSpecifici));
    }
