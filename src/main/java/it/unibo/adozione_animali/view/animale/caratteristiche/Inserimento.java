...
public class Inserimento extends JPanel {
    ...
    public Inserimento() {
        ...
        String[] headers = {"Tipo Caratteristica", "Provincia", "Città", "Numero civico",
                "Codice Animale", "Codice Specifica", "Inserimento Nuovo"};
        gbc.gridy = 0;
        for (int i = 0; i < headers.length; i++) {
            ...
            } else if ("Inserimento Nuovo".equals(headers[i])) {
        ...
        codiceBox.addActionListener(e -> {
            if (controller != null) {
                ...
                boolean nuovo = isNuovoChecked();
                controller.animaleSelezionato(provincia, citta, numero, codAnimale, nuovo);
            }
        });
