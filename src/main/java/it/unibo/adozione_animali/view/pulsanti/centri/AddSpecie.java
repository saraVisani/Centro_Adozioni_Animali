...
public class AddSpecie extends JPanel {
    ...
    private InserimentoSpecieCentroController controller;
    ...
    public void setController(InserimentoSpecieCentroController controller) {
