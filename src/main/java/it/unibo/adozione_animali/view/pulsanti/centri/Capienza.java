...
public class Capienza extends JPanel {
    ...
    private UpdateCapienzaController controller;

    public Capienza() {
        setLayout(new BorderLayout(10, 10));

        JLabel title = new JLabel("Update Capienza Centro ");
    ...
    public void setController(UpdateCapienzaController controller) {
